...
<div id="contact_menu" class="contact_menu overflow-hidden h-[70vh] w-full md:w-1/2 md:left-[25%] bg-white fixed bottom-0 shadow-md shadow-black z-[9999] rounded-t-lg">
  <div class="bar w-full h-10 flex justify-center items-center">
    <div class="bg-black w-20 h-2 rounded-lg bar-class cursor-grab"></div>
  </div>
  <div class="content px-4 py-4 pb-8 overflow-y-scroll h-full">
    <div class="p1 flex items-center space-x-4 px-4">
      <div class="heading text-2xl font-bold"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z"/></svg></div>
        ...
        {#each skills_list as skill}
          <li class="w-32 h-32 rounded-full relative flex justify-center">
            {#each new Array(15) as item, index}
              <div class="h-1/2 w-fit absolute origin-bottom" style="transform: rotate({index*(360/15)}deg);">
                <div class="w-4 h-4 {index < Math.floor(skill.percentage*15) ? skill.bg: "bg-gray-300"} rounded-full"></div>
              </div>
            {/each}
...
<div class="bottom_menu h-[70vh] w-full bg-white fixed bottom-0 shadow-xl shadow-black z-[9999] rounded-t-lg" id="bottom_menu">
  <div class="bar w-full h-10 flex justify-center items-center">
    <div class="bg-black w-20 h-2 rounded-lg bar-class cursor-grab"></div>
  </div>
  <div class="content px-3 py-4">
    <ul class="flex flex-col space-y-4">
      ...
      <a class="flex p-2 space-x-3 rounded-md hover:bg-gray-500 hover:bg-opacity-30 items-center" target="_blank" href="https://twitter.com/themrinmoyreal">
        <!-- Twitter -->
        <svg xmlns="http://www.w3.org/2000/svg" height="1.3em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M459.37 151.716c.325 4.548.325 9.097.325 13.645 0 138.72-105.583 298.558-298.558 298.558-59.452 0-114.68-17.219-161.137-47.106 8.447.974 16.568 1.299 25.34 1.299 49.055 0 94.213-16.568 130.274-44.832-46.132-.975-84.792-31.188-98.112-72.772 6.498.974 12.995 1.624 19.818 1.624 9.421 0 18.843-1.3 27.614-3.573-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 30.214 12.67 47.431 13.319-28.264-18.843-46.781-51.005-46.781-87.391 0-19.492 5.197-37.36 14.294-52.954 51.655 63.675 129.3 105.258 216.365 109.807-1.624-7.797-2.599-15.918-2.599-24.04 0-57.828 46.782-104.934 104.934-104.934 30.213 0 57.502 12.67 76.67 33.137 23.715-4.548 46.456-13.32 66.599-25.34-7.798 24.366-24.366 44.833-46.132 57.827 21.117-2.273 41.584-8.122 60.426-16.243-14.292 20.791-32.161 39.308-52.628 54.253z"/></svg>
        <span>Twitter</span>
      </a>
      <a class="flex p-2 space-x-3 rounded-md hover:bg-gray-500 hover:bg-opacity-30 items-center" target="_blank" href="https://www.instagram.com/themrinmoymondal/">
        <!-- Instagram -->
        <svg xmlns="http://www.w3.org/2000/svg" height="1.3em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"/></svg>
        <span>Instagram</span>
      </a>
      <a class="flex p-2 space-x-3 rounded-md hover:bg-gray-500 hover:bg-opacity-30 items-center" target="_blank" href="https://www.linkedin.com/in/mrinmoy-mondal-319861167/">
        <!-- Linkden -->
        <svg xmlns="http://www.w3.org/2000/svg" height="1.3em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"/></svg>
        <span>Twitter</span>
      </a>
    </ul>
  </div>
...
<header bind:this={header} class="fixed top-0 z-[999] transition-all w-full px-2 py-4 md:px-4 md:py-8 bg-white">
  <div bind:this={header_wrapper} class="wrapper flex border justify-center items-center px-4 py-2 rounded-md shadow-md">
    <button on:click={()=>{
      is_main_menu.set(!$is_main_menu);
    }} class="menu-btn md:hidden hover:bg-gray-300 px-2 py-2 rounded-md cursor-pointer">
      <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z"/></svg>
    </button>
    ...
    <div class="profile-image flex-none w-12 h-12 bg-black rounded-full">
    </div>
  </div>
</header>
